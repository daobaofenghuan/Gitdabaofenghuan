...
public class ZaiXianListAdapter extends BaseAdapter {
    ...
    public ZaiXianListAdapter(Context context, ArrayList<AcceptData> cf2) {
    ...
    public View getView(int position, View converView, ViewGroup arg2) {
        ...
        if (converView == null) {
            view = mInflater.inflate(R.layout.item_listv_zaixian, null);
