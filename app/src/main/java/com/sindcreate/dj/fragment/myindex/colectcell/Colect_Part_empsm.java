...
public class Colect_Part_empsm extends RVBaseCell<Entry> {
    public static final int TYPE = 4004;
    public Colect_Part_empsm(Entry entry){
        super(entry);
    ...
    public RVBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RVBaseViewHolder view= new RVBaseViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_my_collect_part4,parent,false));
