...
public class Foot_Part_empbig extends RVBaseCell<Entry> {
    public static final int TYPE = 4003;
    public Foot_Part_empbig(Entry entry){
        super(entry);
    ...
    public RVBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RVBaseViewHolder view= new RVBaseViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_my_foot_part3,parent,false));
